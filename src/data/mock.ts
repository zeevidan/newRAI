...
export const agents: Agent[] = [
  // Atlas Navigation — fleet routing & warehouse ops
  {
    id: "a1",
    orgId: "org-1",
    name: "Fleet routing manager",
    model: "gpt-4.1",
    status: "active",
    description: "Plans and optimizes robot routes across warehouse zones.",
    managerId: "u2",
    projectIds: ["proj-1"],
  },
  {
    id: "a4",
    orgId: "org-1",
    name: "Route runbook author",
    model: "gpt-4.1-mini",
    status: "active",
    description: "Maintains operational runbooks for fleet workflows.",
    managerId: "u2",
    projectIds: ["proj-1"],
  },
  {
    ...
    model: "claude-sonnet",
    status: "active",
    description: "Validates routes and operations against safety rules.",
    managerId: "u3",
    projectIds: ["proj-1"],
  ...
  // Sentinel Vision — production-line defect detection
  {
    id: "a2",
    orgId: "org-1",
    name: "Production line inspector",
    model: "claude-sonnet",
    status: "active",
    description: "Inspects production line output for defects.",
    managerId: "u9",
    projectIds: ["proj-2"],
  },
  {
    id: "a6",
    orgId: "org-1",
    name: "Classification pipeline manager",
    model: "gpt-4.1",
    status: "active",
    description: "Manages the vision classification pipeline.",
    managerId: "u9",
    projectIds: ["proj-2"],
  },
  {
    id: "a7",
    orgId: "org-1",
    name: "Label set author",
    model: "gpt-4.1-mini",
    status: "paused",
    description: "Authors and updates defect label sets.",
    managerId: "u5",
    projectIds: ["proj-2"],
  },
  // Relay Comms — field handoff protocols
  {
    ...
    model: "gpt-4.1-mini",
    status: "paused",
    description: "Orchestrates field handoff protocols between teams.",
    managerId: "u10",
    projectIds: ["proj-3"],
  },
  {
    id: "a8",
    orgId: "org-1",
    name: "Field comms author",
    model: "claude-sonnet",
    status: "active",
    description: "Drafts field communication templates and notices.",
    managerId: "u10",
    projectIds: ["proj-3"],
  },
  {
    ...
    model: "gpt-4.1",
    status: "active",
    description: "Validates handoff protocol compliance.",
    managerId: "u10",
    projectIds: ["proj-3"],
  },
  ...
  },
  {
    id: "a10",
    orgId: "org-2",
    name: "Pipeline documentation author",
    model: "gpt-4.1-mini",
    status: "active",
    description: "Documents telemetry pipeline architecture and runbooks.",
    managerId: "u11",
    projectIds: ["proj-4"],
  },
  {
    id: "a11",
    orgId: "org-2",
    name: "Anomaly detection checker",
    model: "claude-sonnet",
    status: "active",
    description: "Reviews anomaly detection alerts and thresholds.",
    managerId: "u8",
    projectIds: ["proj-4"],
  },
  ...
  },
  {
    id: "a14",
    orgId: "org-3",
    name: "Pilot workflow manager",
    model: "gpt-4.1",
    status: "active",
    description: "Manages pilot inspection workflow orchestration.",
    managerId: "u13",
    projectIds: ["proj-5"],
  },
  {
    ...
    model: "gpt-4.1-mini",
    status: "active",
    description: "Generates inspection summary reports.",
    managerId: "u13",
    projectIds: ["proj-5"],
  },
]
...
export const projectTasks: Record<string, Task[]> = {
  "proj-1": [
    ...
    { id: "t4", title: "Tune routing agent latency", assignee: "Fleet routing manager", status: "in_progress", due: "May 24" },
  ...
  "proj-2": [
    ...
    { id: "t8", title: "Benchmark line QA accuracy", assignee: "Production line inspector", status: "todo", due: "May 27" },
  ...
  "proj-3": [
    ...
    { id: "t13", title: "Test field comms writer failover", assignee: "Field comms author", status: "todo", due: "Jun 8" },
    { id: "t20", title: "Validate protocol QA coverage", assignee: "Protocol validator", status: "in_progress", due: "Jun 6" },
  ],
  "proj-4": [
    { id: "t14", title: "Ship telemetry batch ingest", assignee: "Taylor Brooks", status: "in_progress", due: "May 25" },
    { id: "t15", title: "Calibrate anomaly QA thresholds", assignee: "Anomaly detection checker", status: "todo", due: "May 31" },
  ...
  "proj-5": [
    ...
    { id: "t19", title: "Configure inspection QA prompts", assignee: "Inspection checklist QA", status: "todo", due: "Jun 4" },
    { id: "t21", title: "Draft pilot report templates", assignee: "Inspection report author", status: "todo", due: "Jun 6" },
  ],
}
...
export const agentActivity: Record<string, ActivityItem[]> = {
  a1: [
    { id: "aa1", action: "rebalanced fleet routes for zone B", actor: "Fleet routing manager", time: "Today, 10:22 AM" },
    { id: "aa2", action: "escalated congestion alert to Morgan Lee", actor: "Fleet routing manager", time: "Today, 8:05 AM" },
    { id: "aa3", action: "completed nightly route optimization", actor: "Fleet routing manager", time: "Yesterday" },
  ],
  a4: [
    { id: "aa4", action: "published runbook section 4.2", actor: "Route runbook author", time: "Today, 9:40 AM" },
    { id: "aa5", action: "drafted failover procedure update", actor: "Route runbook author", time: "May 17" },
  ],
  a5: [
    { id: "aa6", action: "passed safety compliance scan", actor: "Safety compliance checker", time: "Today, 7:15 AM" },
    { id: "aa7", action: "flagged 2 route edge cases", actor: "Safety compliance checker", time: "May 18" },
  ],
  a2: [
    { id: "aa8", action: "inspected 1,240 units on line 4", actor: "Production line inspector", time: "Today, 11:30 AM" },
    { id: "aa9", action: "updated defect threshold to 0.98", actor: "Production line inspector", time: "Yesterday" },
  ],
}
