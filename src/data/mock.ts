...
export const agentAccessGrants: AgentAccessGrant[] = [
  {
    ...
    agentId: "a1",
    projectId: "proj-1",
    skillIds: ["skill-platform-data-analysis", "skill-org-acme-strategy"],
  ...
  },
  {
    ...
    skillIds: ["skill-platform-pdf", "skill-org-acme-strategy"],
    integrationIds: [],
    vaultIds: ["v2"],
    toolIds: [],
  },
  {
    ...
    agentId: "a2",
    projectId: "proj-2",
    skillIds: ["skill-platform-data-analysis", "skill-platform-customer-support"],
